export const supportedTextFonts = ['Segoe UI', 'Georgia', 'Consolas', 'Trebuchet MS'];
...
const isSupportedTextFont = (value) => typeof value === 'string' && supportedTextFonts.includes(value);
export const assertAppSettings = (settings) => {
